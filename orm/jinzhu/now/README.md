...
```
go get -u github.com/switfs/shadow-framework/orm/jinzhu/now
```
...
```go
import "github.com/switfs/shadow-framework/orm/jinzhu/now"
...
* <http://github.com/switfs/shadow-framework/orm/jinzhu>
* <wosmvp@gmail.com>
